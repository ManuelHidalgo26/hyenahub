      ...
      <div className="relative z-10 w-full max-w-sm sm:max-w-md animate-slide-up">
        <div className="card-dark rounded-3xl p-8 shadow-2xl shadow-black/70">
          ...
          <div className="text-center mb-8">
            <img src="/hyena-logo.png" alt="HyenaHub" className="w-14 h-14 rounded-2xl shadow-lg shadow-orange-500/35 mb-4 glow-orange object-cover" />
...
function RoleCard({ onClick, icon, title, description, gradient, glow }: {
  onClick: () => void;
